...
;  '((t (:foreground "#4d4d3d")))  ; grey25, but with more yellow in it
  '((t (:foreground "#797969")))  ; grey25, but with more yellow in it
            ...
            (lambda ()
              (font-lock-add-keywords
               ...
               (list
                ...
                (highlight-keywords 'ansi-lisp-boolean '(nil t))

                (highlight-keywords 'ansi-lisp-constant '(array-dimension-limit
                ...
                (highlight-keywords 'ansi-lisp-declaration '(type compilation-speed
                        debug declaration dynamic-extent ftype
                        ignorable ignore inline notinline optimize
                        safety space special speed))

                (highlight-keywords 'ansi-lisp-condition-type '(arithmetic-error
                ...
                (highlight-keywords 'ansi-lisp-function '(- / * + abort and atom bit
                ...
                (highlight-keywords 'ansi-lisp-generic-function '(add-method
                ...
                (highlight-keywords 'ansi-lisp-macro '(lambda or setf assert
                ...
                (highlight-keywords 'ansi-lisp-special-operator '(function block catch
                ...
                (highlight-keywords 'ansi-lisp-type '(array base-char base-string
                ...
                (highlight-keywords 'ansi-lisp-unknown
                        '(method-combination))

                (highlight-keywords 'ansi-lisp-global-variable '(// /// ** ***
                ...
                (highlight-keywords 'ansi-lisp-expression
                        '(declare))
)))))
